    ...
    <div className="grid min-h-screen lg:grid-cols-[1.05fr_1fr]">
      ...
      <div className="flex items-center justify-center bg-bg px-6 py-12">
        <div className="w-full max-w-[360px]">
          ...
          <button
            type="button"
            onClick={() => doSignIn("demo@neurodoc.app", "demo1234")}
            disabled={loading}
            className="flex h-10 w-full items-center justify-center rounded-md border border-border bg-transparent text-[14px] font-medium text-text transition-colors hover:bg-surface disabled:opacity-60"
          >
          ...
          <p className="mt-10 text-center text-[13px] text-muted">
            ...
            <Link href="/signup" className="font-medium text-text hover:text-accent">
              Create one
            </Link>
          </p>
        </div>
